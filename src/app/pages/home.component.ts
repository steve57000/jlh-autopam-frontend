...
const DEFAULT_METIERS_PICTOS: MetiersPicto[] = [
  ...
  {
    img: '/uploads/icons/picto-metier-geometrie.png',
    label: 'Géométrie',
  ...
  {
    img: '/uploads/icons/picto-metier-revision_constructeur.png',
  ...
  {
    img: '/uploads/icons/picto-metier-vidange.png',
    label: 'Vidange',
